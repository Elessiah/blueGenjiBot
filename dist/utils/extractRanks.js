...
async function extractRanks(client, message, silence = false) {
    ...
    if (matchs.length === 0) {
        if (!silence) {
            answerTmp(client, message, "It seems that you didn't specify any rank. To get more responses from other users, I recommend specifying the rank range you're looking for.", 30000);
        }
        matchs = ranks;
    }
    return matchs;
...
export { extractRanks };
//# sourceMappingURL=extractRanks.js.map