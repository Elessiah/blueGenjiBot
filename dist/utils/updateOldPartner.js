const { ranks } = require("./globals.ts");
const setRankFilter = require("./setRankFilter.ts");
const defineRankRange = require("./defineRankRange.ts");
...
export {};
//# sourceMappingURL=updateOldPartner.js.map